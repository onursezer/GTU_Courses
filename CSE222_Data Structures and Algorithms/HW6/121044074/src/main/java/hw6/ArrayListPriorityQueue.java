 ...
 * @author Onur Sezer
 */
public class ArrayListPriorityQueue<E> implements PriorityQueue<E>{
    // Data Field
    ...
    // Constructor
    public ArrayListPriorityQueue(Comparator<? super E> comparator) {
